...
public class About_info extends Fragment {
    ...
    private AboutInfoViewModel mViewModel;

    public static About_info newInstance() {
        return new About_info();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AboutInfoViewModel.class);
